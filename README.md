...
- [**Data Types**](./01-fundamentals/08-data-types/README.md)
  - [Primitives](./01-fundamentals/08-data-types/primitives.js)
  - [Reference Types](./01-fundamentals/08-data-types/reference.js)
  - [Type Checking](./01-fundamentals/08-data-types/type-checking.js)
...
- [**Operators**](./01-fundamentals/10-operators/README.md)
  - [Arithmetic](./01-fundamentals/10-operators/arithmetic.js)
  - [Assignment](./01-fundamentals/10-operators/assignment.js)
  - [Comparison](./01-fundamentals/10-operators/comparison.js)
  - [Logical](./01-fundamentals/10-operators/logical.js)
  - [Precedence](./01-fundamentals/10-operators/precedence.js)
  - [Ternary](./01-fundamentals/10-operators/ternary.js)
